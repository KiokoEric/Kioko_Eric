...
import Resume from "../../assets/Documents/Eric M Kioko.pdf"; 
    ...
    <div className='flex flex-col items-center justify-center gap-10 mt-5 m-auto w-11/12 sm:flex-row'>
        ...
        <section className='flex flex-col items-center justify-center w-11/12 sm:w-6/12 xl:items-start'>
            <Heading 
                ...
                FirstText='I am a FullStack Web Developer based in Nairobi, Kenya. I am a passionate and enthusiastic software developer with a passion for crafting clean, efficient, and user-friendly software solutions.'
            />
            <Button
                ID='Button'
                onClick={openResume}
